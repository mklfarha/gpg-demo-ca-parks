...
class RecreationAreaForm extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            entity: props.entity
    ...
    render() {
        return (
            <div className="formWrapper"  style={{borderTopColor:StringToColour('recreation_area')}}> 
                    <Formik    
                        ...
                        if (!isValid) {                                
                            toast.error('Error validating form',{
                                ...
                                toastId: "recreation_area-validation"
                            });                                
                        } else {
                            toast.dismiss("recreation_area-validation");
                        }
                        return (                            
...
export default RecreationAreaForm